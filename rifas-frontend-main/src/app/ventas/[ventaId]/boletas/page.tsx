  ...
  if (error) {
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-sm border border-red-200 p-6 max-w-md">
          <p className="text-red-600 font-medium mb-4">{error}</p>
          <button
            onClick={() => router.back()}
            className="px-4 py-2 bg-slate-200 text-slate-800 rounded-xl hover:bg-slate-300"
          >
            Volver
          </button>
        </div>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-6">
          ...
          <p className="text-slate-600 text-sm">
            ...
            {estadoVenta && (
              <span className="ml-2 px-2 py-0.5 rounded-full text-xs font-medium bg-emerald-50 text-emerald-700">
                {estadoVenta}
              </span>
            )}
          </p>
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 w-full justify-center">
                  <Link
                    ...
                    className="px-3 py-1.5 text-sm border border-slate-300 text-slate-700 rounded-xl hover:bg-slate-50"
                  >
                    Ver
                  </Link>
                  <Link
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-3 py-1.5 text-sm bg-indigo-600 text-white rounded-xl hover:bg-indigo-700"
                  >
                    Imprimir
                  </Link>
                </div>
