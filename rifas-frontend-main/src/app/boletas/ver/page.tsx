        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-lg font-bold text-slate-900">Ver Boletas</h1>
            </div>
            <button
              onClick={() => router.push('/boletas/crear')}
              className="px-4 py-2 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white rounded-xl hover:from-indigo-700 hover:to-indigo-800 font-semibold shadow-md shadow-indigo-500/20 transition-colors text-sm"
            >
              Crear Boletas
            </button>
          </div>
