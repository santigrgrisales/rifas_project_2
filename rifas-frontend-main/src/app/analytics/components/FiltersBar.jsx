    ...
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 mb-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="relative">
          <select
            className="appearance-none bg-slate-50 border border-slate-200 text-slate-900 text-base font-medium rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 block w-full md:w-80 px-4 py-2.5 outline-none cursor-pointer transition-all"
            value={selectedRifa || ''}
