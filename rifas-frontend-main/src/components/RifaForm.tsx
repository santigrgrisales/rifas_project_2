          ...
          <div className="md:col-span-2">
            ...
            <div className="relative">
              <input
                ...
                maxLength={200}
                className={`w-full px-4 py-2 pr-20 border rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition-all duration-200 text-slate-900 placeholder-slate-400 ${
          ...
          <div className="md:col-span-2">
            ...
            <div className="relative">
              <textarea
                ...
                maxLength={1000}
                rows={4}
                className={`w-full px-4 py-2 pr-20 border rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition-all duration-200 text-slate-900 placeholder-slate-400 resize-none ${
