      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <button
            ...
            className="px-6 py-2.5 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white rounded-xl hover:from-indigo-700 hover:to-indigo-800 font-semibold shadow-md shadow-indigo-500/20 transition-all font-medium transition-colors"
          >
            Nueva Venta
          </button>
        </div>
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 p-6">
      ...
      <div className="mb-6 p-3 bg-indigo-50 border border-indigo-200 rounded-lg">
        <h3 className="text-sm font-medium text-indigo-900 mb-2">Cliente</h3>
      ...
      <div className="flex space-x-3">
        ...
        {tipoVenta === 'RESERVA' ? (
          <button
            ...
            className="flex-1 px-4 py-2 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white rounded-xl hover:from-indigo-700 hover:to-indigo-800 font-semibold shadow-md shadow-indigo-500/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed font-medium transition-colors"
          >
