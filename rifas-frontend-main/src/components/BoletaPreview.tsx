...
export default function BoletaPreview({ 
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
      <h3 className="text-sm font-bold text-slate-900 uppercase tracking-wider mb-4">Vista Previa de Boleta</h3>
      ...
      <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
        <div className="bg-slate-50 rounded-xl p-3 border border-slate-200">
          <div className="font-semibold text-slate-700 mb-1 text-xs uppercase tracking-wide">Configuración QR:</div>
          <div className="text-slate-500 break-all text-xs">{qrUrl}</div>
        </div>
        <div className="bg-slate-50 rounded-xl p-3 border border-slate-200">
          <div className="font-semibold text-slate-700 mb-1 text-xs uppercase tracking-wide">Código de Barras:</div>
