...
const statusColors = {
  ...
  ACTIVA: 'bg-emerald-50 text-emerald-700 ring-1 ring-emerald-600/10',
  PAUSADA: 'bg-amber-50 text-amber-700 ring-1 ring-amber-600/10',
  TERMINADA: 'bg-sky-50 text-sky-700 ring-1 ring-sky-600/10'
}
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        {getEstadoOptions(rifa.estado).length > 0 && (
                          <select
                            ...
                            className="text-xs text-slate-700 bg-white border border-slate-300 rounded-lg px-2 py-1 hover:border-indigo-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent cursor-pointer transition-colors"
                            defaultValue=""
                          >
